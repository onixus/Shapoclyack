...
function fallbackLabel(isPlatformAdmin: boolean, defaultTenant: string): string {
  return isPlatformAdmin ? "All tenants" : defaultTenant;
}
...
export function TenantSwitcher() {
  ...
  const current = activeTenant ?? fallbackLabel(isPlatformAdmin, defaultTenant);
    ...
    <DropdownMenu>
      ...
      >
        ...
        >
          ...
          />
          {fallbackLabel(isPlatformAdmin, defaultTenant)}
        </DropdownMenuItem>
