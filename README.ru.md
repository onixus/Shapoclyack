...
Документация соответствует релизу [`shapoclyack-0.46-0922`](https://github.com/onixus/Shapoclyack/releases/tag/shapoclyack-0.46-0922).
...
> [!TIP]
> В производственной среде обязательно фиксируйте конкретный тег релиза (например, `0.46-0922`) и не используйте плавающий тег `latest`.
