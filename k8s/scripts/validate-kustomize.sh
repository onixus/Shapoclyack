...
for target in base overlays/dev overlays/prod overlays/prod-ha overlays/api-readonly \
              overlays/agents overlays/enrichment overlays/kind-dev overlays/kind-enrichment; do
