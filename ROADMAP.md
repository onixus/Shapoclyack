...
**Status:** 10.1, 10.2 done; 10.3 Planned.
...
| **P2** | 2–3 sprints | Asset event workflows | In progress: ~~`events.asset.*` bus~~ (done, [10.2](#phase-10--change-detection--alerting-at-asset-level)); remaining [10.3](#phase-10--change-detection--alerting-at-asset-level) — routing policies, webhooks first, retries, DLQ, audit trail; then Jira/ServiceNow |
