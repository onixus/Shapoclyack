...
| [#138](https://github.com/onixus/Shapoclyack/issues/138) | UI | **Done on branch** — Remediation Board (`/remediation`) + comments + ticket *links*. Native Jira/ServiceNow/DefectDojo create is [10.3](#phase-10--change-detection--alerting-at-asset-level)/P2 |
