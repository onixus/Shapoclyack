...
| **P3** | parallel track | Scale & observability | Prometheus/OpenTelemetry, SLOs, server-side pagination, 1k/10k/50k-asset test fixtures, ClickHouse/API/UI profiling, coverage gate + frontend tests in CI |
